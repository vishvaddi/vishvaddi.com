...
if (process.argv[1] && resolve(process.argv[1]) === fileURLToPath(import.meta.url)) {
  ...
  if (!npm) {
    ...
    process.exitCode = runSteps([
      ...
      [process.execPath, '--experimental-strip-types', '--test', 'scripts/pro-api.test.mjs', 'scripts/store-api.test.mjs', 'scripts/training-model.test.mjs', 'scripts/albums-model.test.mjs', 'scripts/voice-text.test.mjs', 'scripts/money-model.test.mjs', 'scripts/kitchen-model.test.mjs', 'scripts/recipe-jsonld.test.mjs', 'scripts/market-proxy.test.mjs'],
      ...
      [process.execPath, 'scripts/materials-answers-e2e.mjs', 'dist'],
